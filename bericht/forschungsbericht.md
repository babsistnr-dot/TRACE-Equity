...
<!--
GLIEDERUNG (Dozentinnen-Vorgabe, in Umsetzung seit 2026-04-22):
1. Abstract                                    ~150 W
2. Einleitung                                  ~250 W (½ S)
3. Theorie                                     ~500 W (1 S)   [NEU — C4]
4. Empirie                                     ~500 W (1 S)   [gekürzt — C3]
5. Darstellung der Ergebnisse & Diskussion     ~1.000 W (2 S) [integriert je Dimension — C2]
6. Handlungsempfehlungen & Limitationen        ~500 W (1 S)   [Empfehlungen NEU — C5]
7. Conclusio, Ausblick und Endzusammenfassung  ~500 W (1 S)   [NEU — C6]
Literaturverzeichnis + Anhang

HTML-Kommentare „PARKING:" markieren alten Text, der im angegebenen
Folge-Commit (C2..C8) in das neue Kapitel integriert oder gelöscht wird.
-->
...
74,1 % (West) wird in Abschnitt 5.4 eigens aufgegriffen.
...
Dieses Muster ist konsistent mit dem Levinson-Befund aus Abschnitt 5.3:
...
**Weitere Abbildungen** ergänzen Abschnitt 5 und sind im Projekt-Repository
