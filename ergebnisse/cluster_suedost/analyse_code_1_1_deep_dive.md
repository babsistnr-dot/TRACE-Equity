...
**Analysedatum:** 08.04.2026
**Datenbasis:** 272 validierte Findings, davon 192 relevant
...
|---|---|
| Findings gesamt | 272 |
| Relevante Findings | 192 |
| Code 1.1 (explizit) | 0 |
| Code 2.x (implizit) | 192 |
| Verhältnis implizit:explizit | nur implizit (kein einziges Code-1.1-Finding) |

---

## 2. Befund: Keine explizite Nennung

Im Curriculum von Cluster SüdOst (Burgenland, Kärnten, Steiermark) wurde **kein einziger** expliziter Begriff für
Chancengleichheit oder Chancengerechtigkeit gefunden.

Das bedeutet nicht, dass das Thema fehlt — im Gegenteil: Es gibt
**192 relevante Findings** in den impliziten Codes (2.1–2.7).
...
Die vollständige Abwesenheit expliziter Begriffsnennungen bei gleichzeitig 192 impliziten Findings zeigt: Cluster SüdOst (Burgenland, Kärnten, Steiermark) verankert Chancengerechtigkeit ausschließlich über pädagogische Handlungskompetenzen, ohne das Konzept explizit zu benennen.
