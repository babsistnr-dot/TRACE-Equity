...
ax.set_title(f'Code-Verteilung im Curriculum Cluster Mitte\n(Alle {len(df)} validierten Findings)',
...
ax.set_xlabel('Anzahl Findings', fontsize=12, fontweight='bold')
ax.set_title('Top 15 haeufigste Keywords im Curriculum Cluster Mitte',
             fontsize=14, fontweight='bold', pad=20)
...
**Datenbasis:** {len(df)} validierte Findings (100% validiert, semantische Duplikate entfernt)
